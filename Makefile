...
.PHONY: vm-up vm-halt vm-reload vm-ssh vm-sync vm-watch vm-cli vm-clean vm-libvirt-perms vm-reset-doc-vm check-images vm-check-images lfs-pull
...
vm-reset-doc-vm:
	vagrant ssh -- -t "sudo virsh destroy doc-tinycore || true; sudo virsh undefine doc-tinycore || true; sudo virsh destroy doc-tinycore-link || true; sudo virsh undefine doc-tinycore-link || true; sudo rm -rf $(NIEP_DIR)/VEM/IMAGES/doc-tinycore $(NIEP_DIR)/VEM/IMAGES/doc-tinycore-link"
