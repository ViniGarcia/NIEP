...
'''
def send_packet(packet_length, mac_dst, ip_dst):
    global message_identifier
    global destination_conns

    dummy_packet = bytes(Ether(src='00:00:00:00:02:01', dst=mac_dst)/IP(src="192.168.122.1", dst=ip_dst)/UDP(sport=6788,dport=6789))
    dummy_payload = 0
...
def measure_packet(packet_length, n_packets):
    ...
    for pkt in range(n_packets):
        ...
        send_time = time.time()
        send_packet(packet_length, '00:00:00:00:02:09', "192.168.124.2")
